...
IL_00de:
		...
		try
		{
			...
			}
			{
				...
				L_11 = VirtualFuncInvoker0< SafeFileHandle_t033FA6AAAC65F4BB25F4CBA9A242A58C95CD406E* >::Invoke(23, ((FileStream_t07C7222EE10B75F352B89B76E60820160FF10AD8*)CastclassClass((RuntimeObject*)L_10, FileStream_t07C7222EE10B75F352B89B76E60820160FF10AD8_il2cpp_TypeInfo_var)));
				V_2 = L_11;
				goto IL_0076_1;
			}
...
IL_0060_1:
			{
				...
				NullCheck(L_16);
				bool L_17;
				L_17 = VirtualFuncInvoker1< bool, int32_t >::Invoke(8, L_16, ((int32_t)200));
			}
