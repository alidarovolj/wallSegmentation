...
public class ARMaskInteractionIntegrator : MonoBehaviour
{
    ...
    {
        // SimpleClickPainter удален при очистке проекта
        LogDebug("ℹ️ SimpleClickPainter больше не существует - удален при очистке");

        // SegmentationManager удален при очистке проекта - используется AsyncSegmentationManager
        LogDebug("ℹ️ SegmentationManager больше не существует - удален при очистке");
    }
