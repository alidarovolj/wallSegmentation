...
public class ARWallPresenter : MonoBehaviour
{
    ...
    private void FitToScreen()
    {
        ...
        // В локальных координатах отрицательная Z означает "перед камерой"
        Vector3 targetLocalPosition = new Vector3(0, 0, distance); // Положительная Z для симулятора
        ...
        // ИСПРАВЛЕНИЕ: В локальных координатах положительный Z означает "перед камерой" в симуляторе
